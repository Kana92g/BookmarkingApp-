...
public static final int BOOKMARK_USER_LIMIT = 5;
public static final int BOOKMARK_COUNT_PER_TYPE = 5;
public static final int BOOKMARK_TYPES_COUNT = 3;
public static final int TOTAL_USER_COUNT = 5;
private static User [] users= new User[TOTAL_USER_COUNT];
private static Bookmark[][] bookmarks= new Bookmark[BOOKMARK_TYPES_COUNT][BOOKMARK_COUNT_PER_TYPE];
private static UserBookmark[] usersBookmarks= new UserBookmark[TOTAL_USER_COUNT*BOOKMARK_USER_LIMIT];
...
private  static void loadUsers() {
	...
	users[4]=UserManager.getInstance().createUser(1004,"user4@semanticsquare.com","test","Dheeru","M",Gender.FEMALE,UserType.CHIEF_EDITOR);	
...
public static UserBookmark[] getUsersBookmarks() {
